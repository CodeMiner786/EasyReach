...
{
    /// <summary>
    /// CreateShippingAddressDto validate korar rule - Controller/Service e ei
    /// validator DI diye inject kore .ValidateAsync(dto) call korte hobe.
    /// </summary>
    public class CreateShippingAddressValidator : AbstractValidator<CreateShippingAddressDto>
    {
        public CreateShippingAddressValidator()
        {
            RuleFor(x => x.UserId)
                .NotEmpty()
